...
public class TakePicturePlantnet : MonoBehaviour
{
    ...
    private IEnumerator CoroutineTakePhoto()
    {
        ...
        /*
        //image pour voir la photo prise #virer hors debug?        
    ...
    private int CheckIdenticalPlants(string scientificName)
    {
        ...
        Debug.Log("We found "+ numberOfIdenticalPlants + " identical plant to last one (0 means it is unique)");
    ...
    private void RewardPlantnet(int numberOfIdenticalPlants)
    {
        ...
        if (numberOfIdenticalPlants == 0)
        {
            rewardAmount = 10;
        }
        else if (numberOfIdenticalPlants < 4)
        {
            rewardAmount = 4;
        }
        else
